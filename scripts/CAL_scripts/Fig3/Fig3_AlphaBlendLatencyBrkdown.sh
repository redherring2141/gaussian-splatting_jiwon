...
then
	...
	#A100
	# python3 /work6/jiwon/NeRF/CAL_3DGS_rev/gaussian-splatting_jiwon/render_profiling.py -m /work6/jiwon/NeRF/models/$1/ --skip_train --CUDAEVENT > ./fig3_XavierAGX_20240813/log_render_CUDAEVENT_$1_$2_$3
