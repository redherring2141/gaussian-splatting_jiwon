...
then
	...
	echo "Processing $1 ..."
	python3 /home/jetson-agx/NeRF/CAL_3DGS_rev/gaussian-splatting_jiwon/render_FPS.py -m /home/jetson-agx/NeRF/models/$1/ --skip_train > ./fig2_data_20240812/log_render_CUDAEVENT_$1_$2
