...
then
	...
	then	
		...
		python3 ./Fig2_LogParser.py ../../../../fig2_XavierAGX_20240812/log_render_CUDAEVENT_$1_$2 ../../../../fig2_XavierAGX_20240812/summary_render_CUDAEVENT.txt $4
		...
		python3 ./Fig2_LogParser.py ../../../../fig2_XavierAGX_20240812/log_metric_CUDAEVENT_$1_$2 ../../../../fig2_XavierAGX_20240812/summary_render_CUDAEVENT.txt $4
	fi
fi
}
